...
<div class="">
    ...
    <div class="col-md-7 col-sm-8 col-xs-12">
        <div class="x_panel">
            ...
            <form class="form-horizontal form-label-left" method="get" action="#">
                ...
                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Type of Loan </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <select class="form-control select-tag" placeholder="Select an Employee">
                      <option>Salary Advance</option>
                      <option>Car Loan</option>
                      <option>Motorcycle Loan</option>
                      </select>
                  </div>
                </div>
                <div class="form-group col-md-12 col-sm-12 col-xs-12">
  ...
  <div class="row">
    <div class="col-md-7 col-sm-8 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Loan Summary <small></small></h2>
          <ul class="nav navbar-right panel_toolbox">
