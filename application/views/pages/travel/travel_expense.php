...
<div class="">
  <div class="page-title">
    <div class="title_left">
      <h3>Travel Expense <small></small></h3>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <ul class="nav navbar-right panel_toolbox">
                <li><a class="collapse-link">Add Travel Expense <i class="fa fa-plus"></i></a>
                </li>
                <li class="dropdown">
                </li>
            ...
            <form class="form-horizontal form-label-left" method="get" action="#">
                ...
                <div class="x_title">
                <h2>Expense Details <small></small></h2>
                  <div class="clearfix"></div>
                </div>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Travel ID </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
                      <input type="text" class="form-control" placeholder="">
                  </div>
                </div>
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12">Type of Expense </label>
                  <div class="col-md-9 col-sm-9 col-xs-12">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Travel Expense List <small></small></h2>
          <ul class="nav navbar-right panel_toolbox">
