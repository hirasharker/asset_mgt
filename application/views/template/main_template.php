...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url();?>build/css/datepicker.min.css" rel="stylesheet">
    <!-- jQuery -->
  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo base_url();?>index.html" class="site_title"><i class="fa fa-paw"></i> <span>IAL KAM</span></a>
            </div>
    ...
    <script src="<?php echo base_url();?>vendors/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js"></script>
    ...
    <script src="<?php echo base_url();?>build/js/bootstrap-datepicker.min.js"></script>
